...
# V2 OrderFilled — BEST-EFFORT / UNVERIFIED. The field set below follows the
# feasibility report; confirm the exact ordering/types against the deployed V2
# ABI before trusting decoded V2 logs. The decoder is ABI-driven, so correcting
# this fragment is the only change needed.
...
def order_filled_topic0(version: str = "v1") -> str:
    return event_topic0(ORDER_FILLED_V2 if version == "v2" else ORDER_FILLED_V1)
